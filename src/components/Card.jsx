...
export default function Card({title, id, excerpt, handleDelete, Link}) {
  return (
    <>
	  ...
	  <div className="max-w-sm bg-white border border-slate-200 rounded-lg shadow dark:bg-slate-800 dark:border-slate-700 hover:scale-110 transition-all">
 
        <img className="rounded-t-lg cursor-pointer" src={`https://picsum.photos/500/300?car=${id}`} alt="" />
