...
export default function BlogList({filteredData,handleSearch,searchKeyword,data}) {
...
<div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 mx-auto pb-3">
              <BlogListCard filteredData={currentItems } /></div>
              
       <ReactPaginate  className="text-white flex p-5 gap-1 mx-auto my-5"
        breakLabel="..."
        nextLabel="Next"
